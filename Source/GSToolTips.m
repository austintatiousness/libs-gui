...
- (void) _clearupWindow
{
  //[_window setFrame: NSZeroRect display: NO]; /*commented this out because it was causing the window to not redisplay*/
...
- (void) _moveDraggedImageToNewPosition
{
  ...
  [_window setFrameOrigin: NSMakePoint(newPosition.x - offset.width, newPosition.y - offset.height)];
